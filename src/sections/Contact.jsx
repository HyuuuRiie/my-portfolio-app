  ...
  return (
    <section className="c-space my-20" id="contact">
      <div className="relative min-h-screen flex items-center justify-center flex-col">
        <img src="/assets/terminal.png" alt="terminalbackround" className="absolute inset-0 min-h-screen" />
        <div className="contact-container">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col space-y-7'>
            <label className="space-y-3">
              ...
              <input type="text" name="name" value={form.name} onChange={handleChange} required className='field-input' placeholder='Megumi Kato' />
            </label>
            <label className="space-y-3">
              <span className='field-label'>Email</span>
              <input type="email" name="email" value={form.email} onChange={handleChange} required className='field-input' placeholder='megumikato@gmail.com' />
            </label>
            <label className="space-y-3">
